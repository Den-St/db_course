...
export class FeePaymentAdd1763747046573 implements MigrationInterface {
    name = 'FeePaymentAdd1763747046573'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "tuition_fees"
            ADD CONSTRAINT "FK_40bc74349ddf549577a3e50480d" FOREIGN KEY ("student_id") REFERENCES "payments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    }
